...
Clonar el repositorio desde el [siguiente link](https://github.com/scastro32/Proyecto-Delilah-Resto).

Desde la consola con el siguiente link:

`git clone https://github.com/scastro32/Proyecto-Delilah-Resto.git .`
...
Clone the repository from the [link](https://github.com/scastro32/Proyecto-Delilah-Resto).
